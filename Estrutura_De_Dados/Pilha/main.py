...
def concatenaPilhas( pilha1:Pilha, pilha2:Pilha )->Pilha:
    ...
    # print(pilha1)
    # print(pilha2)
    # print(pilhaAuxiliar1)
    # print(pilhaAuxiliar2)
...
def checarPalindromo(frase:str):
    ...
    for i in range(len(frase)):
        pilhaAuxiliar.empilha(frase[i])
    
    for j in range(len(frase)):
        elementoComparar=pilhaAuxiliar.desempilha()
        
        if frase[j] != elementoComparar: return False
